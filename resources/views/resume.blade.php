...
@section('content')
    ...
    <!-- ========================================== -->
    <div class="hidden print:block bg-white text-slate-800 w-full text-sm leading-tight">
        <!-- Colored Header -->
        <div class="bg-slate-900 text-white p-8 flex items-start justify-between">
            <div class="flex gap-6 items-center">
                <div class="w-24 h-24 rounded-full overflow-hidden border-4 border-white/20 shrink-0">
                     <img src="{{ asset('images/profile.png') }}" class="w-full h-full object-cover">
                </div>
                <div>
                     <h1 class="text-3xl font-bold mb-1.5">Fajri Yanuar Shiddiq Juanda</h1>
                     <p class="text-lg text-blue-400 font-medium mb-3">Full Stack Developer</p>
                     <div class="flex flex-wrap gap-x-5 gap-y-2 text-sm text-slate-300">
                         <span class="flex items-center gap-1.5"><i data-lucide="mail" class="w-3.5 h-3.5"></i> fajriyanuar1@gmail.com</span>
                         <span class="flex items-center gap-1.5"><i data-lucide="linkedin" class="w-3.5 h-3.5"></i> /in/fajri-yanuar-shiddiq-juanda</span>
                         <span class="flex items-center gap-1.5"><i data-lucide="github" class="w-3.5 h-3.5"></i> /fajrijuanda</span>
                     </div>
                </div>
            </div>
        </div>

        <div class="grid grid-cols-12 items-stretch min-h-0">
            <!-- Left Column: Experience & Education (Width: ~66%) -->
            <div class="col-span-8 p-8 pr-8 space-y-7">
                 <!-- About -->
                 <section>
                     <h2 class="text-sm font-bold text-slate-900 border-b-2 border-slate-200 pb-1.5 mb-3 uppercase tracking-wider flex items-center gap-2.5">
                        <i data-lucide="user" class="w-4 h-4 text-blue-600"></i> Profile
                     </h2>
                     <p class="text-slate-700 text-justify text-sm leading-relaxed">
                         Dedicated <strong>Informatics Engineering student</strong> at Univ. Buana Perjuangan Karawang. Proficient in Full Stack Development with <strong>Laravel, Vue.js, and React</strong>. Passionate about clean code, AI solutions, and building scalable web applications.
                     </p>
                 </section>

                 <!-- Education (Swapped Up) -->
                 <section>
                      <h2 class="text-sm font-bold text-slate-900 border-b-2 border-slate-200 pb-1.5 mb-3 uppercase tracking-wider flex items-center gap-2.5">
                        <i data-lucide="graduation-cap" class="w-4 h-4 text-blue-600"></i> Education
                      </h2>
                      <div class="space-y-4">
                           <div class="flex justify-between items-start">
                                <div>
                                    <h3 class="font-bold text-slate-800 text-base">Univ. Buana Perjuangan Karawang</h3>
                                    <p class="text-sm text-slate-700">Bachelor of Informatics Engineering</p>
                                </div>
                                <span class="text-xs font-semibold text-slate-600 bg-slate-100 px-2 py-1 rounded border border-slate-200 whitespace-nowrap">2022 - Now</span>
                           </div>
                           <div class="flex justify-between items-start">
                                <div>
                                    <h3 class="font-bold text-slate-800 text-base">SMAN 1 Karawang</h3>
                                    <p class="text-sm text-slate-700">Science (MIPA)</p>
                                </div>
                                <span class="text-xs font-semibold text-slate-600 bg-slate-100 px-2 py-1 rounded border border-slate-200 whitespace-nowrap">2016 - 2019</span>
                           </div>
                      </div>
                 </section>

                 <!-- Work Experience (Swapped Down) -->
                 <section>
                      <h2 class="text-sm font-bold text-slate-900 border-b-2 border-slate-200 pb-1.5 mb-3 uppercase tracking-wider flex items-center gap-2.5">
                        <i data-lucide="briefcase" class="w-4 h-4 text-blue-600"></i> Experience
                      </h2>
                      <div class="space-y-5">
                           <!-- Century Battery -->
                           <div>
                                <div class="flex justify-between items-baseline mb-1.5">
                                     <h3 class="font-bold text-slate-800 text-base">PT. Century Batteries Indonesia</h3>
                                     <span class="text-xs font-semibold text-slate-600 bg-slate-100 px-2 py-1 rounded border border-slate-200">Feb 2025 - Aug 2025</span>
                                </div>
                                <p class="text-sm font-semibold text-blue-700 mb-1.5">Internship - IT Support & Development</p>
                                <ul class="list-disc list-inside text-sm text-slate-700 space-y-1 ml-1">
                                    <li>Maintained internal IT infrastructure achieving 99% uptime.</li>
                                    <li>Collaborated with engineering team to debug web applications.</li>
                           ...
                           <div>
                                <div class="flex justify-between items-baseline mb-1.5">
                                     <h3 class="font-bold text-slate-800 text-base">MariBelajar (MSIB Batch 7)</h3>
                                     <span class="text-xs font-semibold text-slate-600 bg-slate-100 px-2 py-1 rounded border border-slate-200">Sep 2024 - Dec 2024</span>
                                </div>
                                <p class="text-sm font-semibold text-blue-700 mb-1.5">Data Analyst & AI Engineer</p>
                                <ul class="list-disc list-inside text-sm text-slate-700 space-y-1 ml-1">
                                    <li>Developed <strong>Echolytics</strong>, an AI-powered analytics platform.</li>
                                    <li>Utilized Python, SQL, and Machine Learning for predictive models.</li>
                 ...
                 <!-- Selected Projects -->
                 <section class="mt-8">
                      <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-5 text-center shadow-sm">
                          <p class="text-sm text-slate-700 mb-2 font-medium">View detailed project portfolio, case studies & documentation:</p>
                          <a href="http://portfolio-fajri.page.gd/" target="_blank" class="text-blue-700 font-bold underline text-lg break-all hover:text-blue-800 transition-colors">
                              http://portfolio-fajri.page.gd/
                          </a>
                      </div>
                 </section>
            </div>

            <!-- Right Column: Skills & Languages (Width: ~33%) -->
            <div class="col-span-4 bg-slate-50 p-8 pl-6 border-l border-slate-200">
                 <div class="space-y-8">
                     <!-- Tech Skills -->
                     <section>
                          <h2 class="text-xs font-bold text-slate-900 border-b-2 border-slate-200 pb-1.5 mb-4 uppercase tracking-wider flex items-center gap-2">
                            <i data-lucide="cpu" class="w-3.5 h-3.5 text-blue-600"></i> Skills
                          </h2>

                          <div class="mb-4">
                              <h4 class="text-xs font-bold text-slate-500 uppercase mb-2">Languages</h4>
                              <div class="flex flex-wrap gap-1.5">
                                  @foreach(['PHP', 'JavaScript', 'TypeScript', 'Go', 'Python', 'SQL', 'Dart'] as $skill)
                                      <span class="text-xs px-2.5 py-1 bg-white border border-slate-200 rounded text-slate-700 font-medium shadow-sm">{{ $skill }}</span>
                                  @endforeach
                              </div>
                          </div>

                          <div class="mb-4">
                              <h4 class="text-xs font-bold text-slate-500 uppercase mb-2">Frameworks</h4>
                              <div class="flex flex-wrap gap-1.5">
                                  @foreach(['Laravel', 'Vue.js', 'React', 'Next.js', 'Nuxt', 'Flutter', 'Tailwind'] as $skill)
                                      <span class="text-xs px-2.5 py-1 bg-white border border-slate-200 rounded text-slate-700 font-medium shadow-sm">{{ $skill }}</span>
                                  @endforeach
                              </div>
                          </div>
                          ...
                          <div>
                              <h4 class="text-xs font-bold text-slate-500 uppercase mb-2">Tools</h4>
                              <div class="flex flex-wrap gap-1.5">
                                  @foreach(['Git', 'Docker', 'Filament', 'Figma', 'GCP'] as $skill)
                                      <span class="text-xs px-2.5 py-1 bg-white border border-slate-200 rounded text-slate-700 font-medium shadow-sm">{{ $skill }}</span>
                                  @endforeach
                     ...
                     <section>
                          <h2 class="text-xs font-bold text-slate-900 border-b-2 border-slate-200 pb-1.5 mb-4 uppercase tracking-wider flex items-center gap-2">
                            <i data-lucide="languages" class="w-3.5 h-3.5 text-blue-600"></i> Languages
                          </h2>
                          <div class="space-y-3 text-xs">
                               <div class="flex justify-between border-b border-slate-200 pb-1.5">
                                   <span class="text-slate-700 font-medium">Indonesia</span>
                                   <span class="font-bold text-slate-900">Native</span>
                               </div>
                               <div class="flex justify-between border-b border-slate-200 pb-1.5">
                                   <span class="text-slate-700 font-medium">English</span>
                                   <span class="font-bold text-slate-900">Proficient</span>
                               </div>
                               <div class="flex justify-between border-b border-slate-200 pb-1.5">
                                   <span class="text-slate-700 font-medium">Korean</span>
                                   <span class="font-bold text-slate-900">Intermediate</span>
                               </div>
                               <div class="flex justify-between border-b border-slate-200 pb-1.5">
                                   <span class="text-slate-700 font-medium">Japanese</span>
                                   <span class="font-bold text-slate-900">Basic</span>
                               </div>
                          </div>
                     </section>
                     ...
                     <section>
                          <h2 class="text-xs font-bold text-slate-900 border-b-2 border-slate-200 pb-1.5 mb-4 uppercase tracking-wider flex items-center gap-2">
                            <i data-lucide="award" class="w-3.5 h-3.5 text-blue-600"></i> Certifications
                          </h2>
                          <div class="text-xs text-slate-600 mb-3 space-y-1.5 font-medium">
                              <p>Data Analytics & AI (MariBelajar)</p>
                              <p>Full Stack Web Dev (Udemy)</p>
                          </div>
                          <a href="https://www.linkedin.com/in/fajri-yanuar-shiddiq-juanda" target="_blank" class="inline-flex items-center gap-1.5 text-blue-700 font-bold hover:underline text-xs bg-blue-50 px-3 py-2 rounded-lg border border-blue-100 w-full justify-center">
                              <i data-lucide="linkedin" class="w-3.5 h-3.5"></i> View on LinkedIn
                          </a>
                     </section>
                 </div>
            </div>
